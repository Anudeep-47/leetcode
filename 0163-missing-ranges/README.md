...
<pre style="position: relative;"><strong>Input:</strong> nums = [0,1,3,50,75], lower = 0, upper = 99
...
<pre style="position: relative;"><strong>Input:</strong> nums = [-1], lower = -1, upper = -1
