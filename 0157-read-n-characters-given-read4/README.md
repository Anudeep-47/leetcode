...
<pre style="position: relative;">    Parameter:  char[] buf4
    Returns:    int
...
<pre style="position: relative;">File file("abcde<code>"); // File is "</code>abcde<code>", initially file pointer (fp) points to 'a'
...
<pre style="position: relative;">    Parameters:	char[] buf, int n
    Returns:	int
...
<pre style="position: relative;"><strong>Input:</strong> file = "abc", n = 4
...
<pre style="position: relative;"><strong>Input:</strong> file = "abcde", n = 5
...
<pre style="position: relative;"><strong>Input:</strong> file = "abcdABCD1234", n = 12
